...
| 13 | ~~**fig8 M vs P attention** combined~~ ✅ 승격 완료 | docs/architecture → 이동 | `fig8_mp_attention/combined/` |
...
본 저장소 (`paper_artifacts/tables/tab2_probing/v11_egodex_summary.csv`,
...
- 통합본: [`fig8_mp_attention/combined/v11_ep44_combined.png`](fig8_mp_attention/combined/v11_ep44_combined.png) — 4행 × 8열 grid
  - col 0/1: raw frames / col 2-5: attention overlays / col 6/7: reconstructions
- v4용 stream 분리 예시: `sample_detail/` (삭제됨, 구 `docs/architecture/` — git 이력 복구 가능)
