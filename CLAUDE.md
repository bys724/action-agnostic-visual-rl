...
자세한 phase별 상황·표는 [docs/RESEARCH_PLAN.md](docs/RESEARCH_PLAN.md) · [docs/eval_protocols.md](docs/eval_protocols.md) · [docs/cluster_sessions.md](docs/cluster_sessions.md) · [docs/PROBING_GUIDE.md](docs/PROBING_GUIDE.md). 본 섹션은 핵심 요약·진행 상황만.
...
**C2~C9** (구 v15 plan, 삭제됨 — git history 참조): C1 ep50 후 fair head-to-head probing + BC-T (C2, C3). C4~C7 즉시 가능 (의존성 없음).
...
자세한 내용은 [`docs/RESEARCH_PLAN.md`](docs/RESEARCH_PLAN.md) · [`docs/eval_protocols.md`](docs/eval_protocols.md), probing 결과는 [`docs/PROBING_GUIDE.md`](docs/PROBING_GUIDE.md), 클러스터 자원·잡 추적은 [`docs/cluster_sessions.md`](docs/cluster_sessions.md) 참고
