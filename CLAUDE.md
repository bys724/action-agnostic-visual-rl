...
- **다음 (계획)**: **no-M ablation** = 같은 코드 routing-off(=image MAE) vs Parvo, 동일 LIBERO BC + OOD eval로 M 기여 격리 ([docs/v15b_retraining_status.md](docs/v15b_retraining_status.md) §11). 본학습 재제출(§6) 보류 중.
