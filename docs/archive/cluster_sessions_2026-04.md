# IBS Cluster Session Log — 2026-04 Archive

본 문서는 2026-04 동안 IBS olaf 클러스터에서 실행한 세션의 archive.
원본은 [`docs/cluster_sessions.md`](../cluster_sessions.md)에서 5월 분리 시점에 이동.

월별 archive 정책: 매월 말 직전 월 entries를 본 형식으로 `docs/archive/cluster_sessions_YYYY-MM.md`로 분리. 누적 사용량 표만 main에 유지.

---

## 진행 중 세션 (sbatch / salloc) — 4월 시점 기록
...
| JobID | Encoder | 결과 |
|-------|---------|------|
| 33633419 | two-stream-v11 ep44 | COMPLETED (5월 초 학습 종료, V2 ckpt — local sanity는 5/3 분 cluster_sessions.md 참조) |
| 33633420 | videomae-ours best | COMPLETED |
| 33633421 | dinov2 | COMPLETED |
| 33633422 | siglip | COMPLETED |
| 33633423 | vc1 | COMPLETED |
...
| JobID | 자원 | --time | 목적 | 결과 |
|-------|------|--------|------|------|
| 33615394 | AIP 1×1 H100 | 30:00 | sanity (1 ep × part1 × 200 vid × bs=64) | PENDING (월 경계 시점) |
| 33615395 | AIP_long 2×4 H100 | 3-12:00:00 | full ablation (50 ep × part1-5) | PENDING (월 경계 시점) |
