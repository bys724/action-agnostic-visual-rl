...
**1차 학습** (33594155, 23:30:22 elapsed, TIMEOUT — `--time` default 23:30 함정): ep12까지 학습. 188 GPU·h.

**Resume** (33600621, --time=3d, RUNNING ~04-25 01:40~): ep13부터 latest.pt 자동 detect. 새 ckpt dir `20260426_014333/`. ep16~ep44 ckpt 5개 추가 저장. 4월 28일 ep50 완주 예상.

**Probing — ep4~ep44 × 12 mode 통합** (1 노드 × 1 H100 × ~15min × 60+ 잡, 누적 ≈ 15 GPU·h):
...
**🏆 ep44 결론**: A+B+D' = +0.288 → v6 ep8 (+0.259) **추월 +0.029**. VideoMAE +0.326까지 격차 -0.038로 좁힘 (ep24 -0.092 → 절반). LR cosine decay 후반에 큰 도약 (ep24→ep44 +0.054).
