...
| ~~33555333~~ | ~~2026-04-21 23:41~~ | ~~AIP_long~~ | ~~2 노드 × 4 H100~~ | ~~v9 residual+patch-norm full run (실제 loss_weight_p=1.0, sanity 결정값 0.02 반영 안 됨). ep4/ep8 probing: concat +0.167/+0.171, M +0.120/+0.181, P +0.100/-0.006. P degrade 관찰 → **v10 전환 위해 13:04 scancel (Elapsed 13:24:52, ep8 저장)**~~ |
| **33570871** | **2026-04-22 13:04** | **AIP_long** | **2 노드 × 4 H100** | **v10 full run — v6 base + mask 0.5/0.75 (MAE-style P mask). loss_weight_p=1.0 (sanity ratio ≈1:1 확인). 50 epoch, --time=3d** |
...
| ~~33569380~~ | ~~2026-04-22 09:05~~ | ~~AIP~~ | ~~1 노드 × 1 H100~~ | ~~v9 resnorm ep4 probing patch_mean_concat (완료 14:42, **R²=+0.167** — v9 P=current +0.154 대비 소폭 상승, concat>M 전환)~~ |
| ~~33569381~~ | ~~2026-04-22 09:05~~ | ~~AIP~~ | ~~1 노드 × 1 H100~~ | ~~v9 resnorm ep4 probing patch_mean_m (완료 14:41, **R²=+0.120** — P=current +0.189 대비 하락. loss_weight_p=0.02 효과로 학습 초반 M 영향 감소 추정)~~ |
| ~~33569382~~ | ~~2026-04-22 09:05~~ | ~~AIP~~ | ~~1 노드 × 1 H100~~ | ~~v9 resnorm ep4 probing patch_mean_p (완료 14:41, **R²=+0.100** — P=current -0.102 대비 정반대. residual+norm이 action-relevant motion feature를 실제로 만든 첫 증거)~~ |
| ~~33569895~~ | ~~2026-04-22 11:57~~ | ~~AIP~~ | ~~1 노드 × 1 H100~~ | ~~v9 resnorm ep8 attention compare + rotation viz (완료 2:32). attn_v9_resnorm_ep8.png + rotation 4샘플. P Attn이 ep4 focused → ep8 uniform으로 퇴화 관찰 (mean-pool 수준 축약)~~ |
| ~~33569897~~ | ~~2026-04-22 12:07~~ | ~~AIP~~ | ~~1 노드 × 1 H100~~ | ~~v9 resnorm ep8 probing m_only (CLS_M, 완료 14:41) — **R²=-0.073** (CLS_M은 학습 안 됨, mean-pool 대체 필요 재확인)~~ |
| ~~33569898~~ | ~~2026-04-22 12:07~~ | ~~AIP~~ | ~~1 노드 × 1 H100~~ | ~~v9 resnorm ep8 probing p_only (CLS_P, 완료 14:41) — **R²=+0.004** (uniform attention 결과: CLS_P 자체는 정보 거의 없음)~~ |
| ~~33569899~~ | ~~2026-04-22 12:07~~ | ~~AIP~~ | ~~1 노드 × 1 H100~~ | ~~v9 resnorm ep8 probing patch_mean_m (완료 14:41) — **R²=+0.181** (ep4 +0.120 → 상승, M stream 안정 학습)~~ |
| ~~33569900~~ | ~~2026-04-22 12:07~~ | ~~AIP~~ | ~~1 노드 × 1 H100~~ | ~~v9 resnorm ep8 probing patch_mean_p (완료 14:41) — **R²=-0.006** (ep4 +0.100 → 퇴화. P degrade 확정)~~ |
| ~~33569901~~ | ~~2026-04-22 12:07~~ | ~~AIP~~ | ~~1 노드 × 1 H100~~ | ~~v9 resnorm ep8 probing concat (CLS [M;P], 완료 14:51) — **R²=-0.094** (CLS-only는 정보 손실)~~ |
| ~~33569902~~ | ~~2026-04-22 12:07~~ | ~~AIP~~ | ~~1 노드 × 1 H100~~ | ~~v9 resnorm ep8 probing patch_mean_concat (완료 14:51) — **R²=+0.171** (ep4 +0.167 → 거의 동일, M 기여로 유지). 종합: P degrade로 v10 전환 결정~~ |
| ~~33570865~~ | ~~2026-04-22 12:39~~ | ~~AIP~~ | ~~1 노드 × 1 H100~~ | ~~v10 sanity (v6 base + mask 0.5/0.75, MAE-style P mask, 완료 1:45). forward/backward OK → full run 제출~~ |
| **33573913** | **2026-04-22 20:53** | **AIP** | **1 노드 × 1 H100** | **v10 ep4 attention viz + rotation diagnostic (TAG=v10_ep4, P_TARGET=future)** |
| **33573914** | **2026-04-22 20:53** | **AIP** | **1 노드 × 1 H100** | **v10 ep4 probing patch_mean_concat (gap=10) — v6 ep8 +0.259 비교 기준** |
| **33573915** | **2026-04-22 20:53** | **AIP** | **1 노드 × 1 H100** | **v10 ep4 probing patch_mean_m** |
| **33573916** | **2026-04-22 20:53** | **AIP** | **1 노드 × 1 H100** | **v10 ep4 probing patch_mean_p — mask_p=0.75 효과로 P 학습 강화 여부 확인** |
