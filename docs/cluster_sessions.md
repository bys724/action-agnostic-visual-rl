...
| 40276371~376 | normal V100 1×1 ×6 | 01:30:00 | **probe 수렴 진단** — F1 raw·C0 M 단독 × seed{42,1,2}, `PROBE_EPOCHS=60`(정규 20의 3배, 진단 전용·표에 미혼입). 질문: 20ep 비교가 raw에 불리하게 치우쳤나. SUFFIX=refine_{F1_m,C0_m}_e60_s{42,1,2} | ⏳ 제출 09-25 |
