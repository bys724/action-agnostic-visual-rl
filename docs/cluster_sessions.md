...
| 36828716~718 | normal V100 1×1 ×3 | 04:00:00 | **meanmax readout sanity** (3000클립) — readout-병목 정량화 매트릭스 사전 검증: 효율 개선(autocast fp16 + rev 토큰 재사용) throughput 실측(기준 dinov2 59/parvo 166 c/s) + 신규 mode(m_only) 경로 검증. 716=dinov2·717=p_t_m·718=m_only | 🔄 제출 (2026-07-12) |
