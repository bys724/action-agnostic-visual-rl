...
| 40275371 | AIP_long 2×4 H100 | 2-00:00:00 | **🚀 C1 본학습** — C0 submit line 그대로(part1·50ep·batch128/GPU eff1024·LR2.8e-4·384/6·m6·no-Sobel·pair·comp·floor0.02, caseA1.0·indep_rot0.1·qk off 기본값) + `BRIGHT_AUG=1`. SUFFIX=refine_comp_s_bright. 예상 ~14h wall ≈ 110 GPU·h (C0 실측 13h42m). `--test-only` 예상 시작 09-26 02:03 (AIP 전 노드 점유) | ⏳ RUNNING — 09-25 16:33 시작(예상보다 9.5h 앞당겨짐, olaf-g[003-004]). ep4 ckpt 18:1x 저장. epoch avg L_t/L_mj: ep1 0.0505/0.0431 · ep2 0.0175/0.0208 · ep3 0.0094/0.0081 · ep4 0.0084/0.0061 (C0 ep1·2 = 0.0484/0.0411·0.0170/0.0197). `[bright]` dc_offset 0.056 vs motion_absdl 0.071 안정. 중간 점검(ep4): Model args·params·샘플 수 C0와 `--bright-aug` 외 동일 · NaN/발산 없음 · L_mA 비음·→0 · ⚠️ **throughput ~3,110 samp/s = C0(4,750)의 66%** (steady ep 1,480s vs 975s; 노드 전용 점유라 타 잡 경합 아님, 원인 미확인) → ETA 09-26 ~14:00, 총 ~21.5h ≈ **172 GPU·h**(추정 110 대비 +60) |
