...
| **33346962** | **2026-04-20 14:24** | **AIP_long** | **2 노드 × 4 H100** | **Two-Stream v8 full training — L_M + λ·L_P (λ_max 0.2, warmup 10ep) + α·L_var (0.1), EMA τ 0.996, mask 0.3/0.5, **50 epoch**. ep4 저장 완료 (Loss 0.0065~0.0139, LR warmup 中). 성분별(L_M/L_P/L_var) 로그 미분리 — λ warmup 후 collapse 감지 어려움 주의. 설계: docs/architecture/v8_siamsimmae.md** |
| ~~33451082~~ | ~~2026-04-20 21:28~~ | ~~AIP~~ | ~~1 노드 × 1 H100~~ | ~~v8 ep4 attention viz (완료 1:48, attn_v8_ep4.png — student M/P + teacher P + Pred M, collapse 징후 없음)~~ |
