...
| 36848626 | AIP 1×4 H100 | 00:40:00 | **안정화 sanity** (§4-b iii′-a 재설계, 사용자 확정 — commit `9851613`) — 1ep·MAX_VIDEOS=1000·SUFFIX=sanity_qknorm. **QK_NORM=1 + ADAM_BETA2=0.95 + ADAM_EPS=1e-6 + K=100**. 검증: ① `--qk-norm`·betas 로그 출력 ② qk-norm 텐서 124개 ckpt 반영 ③ loss 정상(앵커 ~0.49) ④ guard 무발동 완주 | 🔄 제출 (07-16) |
