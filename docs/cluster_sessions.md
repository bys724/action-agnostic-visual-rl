...
| **33451989** | **2026-04-21 05:43** | **AIP_long** | **2 노드 × 4 H100** | **Two-Stream v8 full 2차 — L_P BYOL form (λ_max=0.05, warmup 10ep) + cls_m_grad_ratio=0.3 + mask_ratio_m 0.5. 50 epoch. 1차 실패 원인 복합 대책 적용** |
