...
| 36829353 | normal V100 1×1 | 04:00:00 | **compositional split sanity** (500클립, p_t_m) — Something-Else split(물체 train/val disjoint 검증 완료) `--ann-dir` 경로 e2e. 사전 등록 = correspondence_eval_plan §7 경로 1-b | 🔄 제출 (2026-07-12) |
