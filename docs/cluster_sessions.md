...
| **33282021** | **2026-04-19 21:3x** | **AIP_long** | **2 노드 × 4 H100** | **v7-big +attention isolation — P-stream self-attn과 CLS exchange 모두에서 CLS_P_bg ↔ CLS_P_motion 직접 attention 차단. 나머지 설정 동일.** |
