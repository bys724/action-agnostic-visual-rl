...
| **33492965** | **2026-04-21 15:48** | **AIP_long** | **2 노드 × 4 H100** | **Two-Stream v9 full run — MAE P target(frame_t), mask 0.3/0.75, APE+rotation aug, loss_weight_p=1.0. 50 epoch, --time=3d. v4 구조 + P decoder target만 frame_t로 변경 (EMA teacher 완전 제거)** |
