...
| 36829354 | normal V100 1×1 | 04:00:00 | **m_only 표준 split** (S, mean) — 사용자 가설: "P의 semantic이 M의 motion 분류를 방해했나" (선례: B-part1 P⊕M<M단독 red flag). 비교: p_t_m 5.72/p_t_p_tk 2.95. ⚠️ 1-stream=절반 차원 caveat | 🔄 제출 (2026-07-12) |
| 36829355~359 | normal V100 1×1 ×5 | 04:00:00 | **compositional 본 매트릭스** (train 54.9k/val 57.9k, mean·fp16) — 355=`p_t_m`·356=`p_t_p_tk`·357=dinov2·358=siglip·359=vmae. 판정 = §7 경로 1-b 사전 등록(내부 대조 ≥+2%p AND 격차 ≥5%p 축소) | 🔄 제출 (2026-07-12) |
| 36829360 | normal V100 1×1 | 04:00:00 | **m_only compositional** — P-방해 가설을 물체-disjoint 조건에서도 검정 (표준 m_only 36829354와 쌍) | 🔄 제출 (2026-07-12) |
