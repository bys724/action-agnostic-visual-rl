...
| 36828523/524 | normal V100 1×1 ×2 | 02:00:00 | **JHMDB B-full exploratory** (호기심 확인, 523=P/524=M) — ⚠️ gate는 ckpt=S로 사전 등록·FAIL 확정, 본 결과는 **관찰 전용**(사후 gate 구제 금지, 보고하려면 새 사전 등록 필요) | 🔄 제출 (2026-07-12) |
