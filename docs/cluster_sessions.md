...
| **33012271** | **2026-04-15 10:15** | **AIP_long** | **2 노드 × 4 H100** | **Two-Stream APE 진단 학습 (--use-ape, EPOCHS=50이나 ep5 저장 확인 후 수동 cancel, reference V4 RoPE와 warmup/LR 완전 일치, CHECKPOINT_SUFFIX=ape_diagnostic)** |
