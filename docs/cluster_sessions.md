...
| 36177296 | AIP_long 2×4 H100 | 1-12:00:00 | **CoMP-MAE-S 본학습 (STEP 1, ours/gate)** — v16 대칭 cross-recon·ViT-S(384/6·m6)·no-Sobel·pair·**part1 full·50ep**. **batch128/GPU(eff 1024)·LR 2.8e-4**(sweep 최적). floor**0.02**(|ΔL| 가중 유효화)·caseA_prob1.0·λ_M1.0·mask_m0.5. SUFFIX=step1_comp_mae_s. 추정 ~111 GPU·h(8GPU ~15-20h wall). gate=health(collapse 없이 patch+CLS R²)+OOD slope vs VideoMAE(−0.083). 모니터: L_t/tk/pred + L_mA(정지)/L_mB(동적) | 🔵 RUNNING |
