...
| 36855035 | AIP_long 2×4 H100 | 2-00:00:00 | **🚀 본 잡: CoMP-S(qk) part1+3 50ep** — SPLITS=part1,part3(100,013 vids)·EPOCHS=50·SUFFIX=comp_mae_s_p13_50ep_qk(fresh init)·QK_NORM=1·β₂0.95·eps1e-6·K=100. 시작 로그 검증 ✓: `Splits: part1,part3`·10,001,300 samples·`--qk-norm`·params 56,117,504(6차 sanity 일치)·save 4ep·eval 5ep | 🔄 실행 중 (07-18 17:18~, olaf-g[004,012]). 예상 ~44h → 07-20 완료 |
| 36855038 | AIP_long 2×4 H100 | 1-00:00:00 | **timeout-resume 잡** (`afternotok:36855035`, kill-on-invalid-dep) — 48h 초과 시 auto-resume로 잔여 ep 완주(same SUFFIX dir glob). 정상 완주 시 자동 취소 | 🔄 대기 (Dependency) |
