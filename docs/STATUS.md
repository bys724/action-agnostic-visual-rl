...
- **판정 (A)·(B) 최소 잡 (raw ΔL, seed 42) [잠정 · seed 1]**: LIBERO 전이 — 같은 suite 평균 0.162 → 6방향 전이 평균 −0.320(spatial↔goal −0.085/−0.131). CALVIN 라벨 효율 — 100/20/5/2% = 0.214/0.230/0.260/0.223(step 매칭), **raw는 라벨 2%에도 안 무너짐**. 전체(6팔×seed3, 약 34잡) 제출은 사용자 승인 대기.
