...
|---|---|---|---|
| `aaai27_supplement_ckpt.tar` | 420 MB | **AAAI-27 code supplement** ckpt 2종 (weights-only, 7/31 AoE — docs/code_release_prep.md §4-b) | `{comp_mae_s,plain_xmae_s}.pt` + `*.train_meta.json` + `SHA256SUMS` → `release/aaai27_supplement/checkpoints/`에 전개 |
